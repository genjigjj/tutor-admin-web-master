<template>
  <div class="app-container">
    ...
    <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
                   ...
                   :page-sizes="[10, 20, 30, 40]" :page-size="listQuery.size"
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="角色权限" prop="url">
              <el-select v-model="tempForm.role" placeholder="选择角色权限">
                <el-option
          ...
          <el-col :span="12">
            <el-form-item label="打开方式" prop="type">
              <el-radio-group v-model.number="tempForm.type">
                <el-radio :label="1">本窗</el-radio>
                <el-radio :label="2">新窗</el-radio>
              </el-radio-group>
            </el-form-item>
          </el-col>
          <el-col :span="12">
